...
def pipelineBeingGeneratedName = "DE_Spinnaker_cENM_5K_Rollback_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '<p>This job is used to update DE cENM 5K Rollback spinnaker pipeline</p>'))


    parameters {
        stringParam('SLAVE', "${OPENSTACK_SLAVES}", 'Slave to run pipeline against')
        stringParam(commonParams.spinnakerPipelineName('fem 35s11: DE cENM_5K_Rollback'))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/spinnaker_pipelines/cenm/5k_rollback/Jenkinsfile")
        }
    }
}