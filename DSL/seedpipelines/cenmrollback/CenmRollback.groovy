...
def pipelineBeingGeneratedName = "cENM_Rollback_Flow"
...
If you choose deployment mechanism as CSAR please select the value as eric-enm-integration-production-values or eric-enm-integration-extra-large-production-values only.
        ...
        choiceParam('use_case', ['Rollback'], 'Select the appropriate operation to be done.')
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_rollback/Jenkinsfile")
        }
    }
}