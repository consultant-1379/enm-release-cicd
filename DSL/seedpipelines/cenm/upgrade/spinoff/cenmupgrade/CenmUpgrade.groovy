...
def pipelineBeingGeneratedName = "SPINOFF_cENM_Upgrade_Functional_Flow"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '<p>This job is used to upgrade ENM software on a cENM environment.</p>'))
...
If you choose deployment mechanism as CSAR please select the value as eric-enm-integration-production-values or eric-enm-integration-extra-large-production-values only.
        ...
        choiceParam('Artifact_type', ['csar', 'csar_lite', 'snapshot_csar_lite'], 'This parameter acts as the flow controller to select the deployment mechanism either csar or csar-lite.')
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm/upgrade/spinoff/cenm_upgrade/Jenkinsfile")
        }
    }
}
