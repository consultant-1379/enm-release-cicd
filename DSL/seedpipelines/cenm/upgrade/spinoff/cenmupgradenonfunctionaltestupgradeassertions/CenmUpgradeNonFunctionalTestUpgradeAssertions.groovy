...
def pipelineBeingGeneratedName = "Spinoff_cENM_Non_Functional_Test_Upgrade_Assertions_Flow"
...
Set to False if you would like to trigger Functional loop.''')
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm/upgrade/spinoff/cenm_upgrade_non_functional_test_upgrade_assertions/Jenkinsfile")
        }
    }
}
