...
def pipelineBeingGeneratedName = "SPINOFF_cENM_Upgrade_Functional_Acceptance_Tests_Flow"
  ...
  <li>The RFA250 child job will then <b>always</b> kick off the Post RFA250 flow</li>
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm/upgrade/spinoff/cenm_upgrade_functional_acceptance_tests/Jenkinsfile")
        }
    }
}
