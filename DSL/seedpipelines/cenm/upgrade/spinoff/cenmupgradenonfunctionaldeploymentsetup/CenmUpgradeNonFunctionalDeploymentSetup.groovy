...
def pipelineBeingGeneratedName = "Spinoff_cENM_Upgrade_Non_Functional_Deployment_Setup_Flow"
...
Set to False if you would like to trigger Functional loop.''')
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm/upgrade/spinoff/cenm_upgrade_non_functional_deployment_setup/Jenkinsfile")
        }
    }
}
