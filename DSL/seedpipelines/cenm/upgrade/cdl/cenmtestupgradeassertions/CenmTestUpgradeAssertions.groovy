...
def pipelineBeingGeneratedName = "CDL_cENM_Test_Upgrade_Assertions_Flow"
  ...
  <li>It runs APTU</li>
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm/upgrade/cdl/cenm_test_upgrade_assertions/Jenkinsfile")
        }
    }
}
