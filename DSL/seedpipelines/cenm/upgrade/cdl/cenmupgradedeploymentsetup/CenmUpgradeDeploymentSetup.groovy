...
def pipelineBeingGeneratedName = "CDL_cENM_Upgrade_Deployment_Setup_Flow"
  ...
  <li>It copies RVB TestScripts repo to the Environment</li>
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm/upgrade/cdl/cenm_upgrade_deployment_setup/Jenkinsfile")
        }
    }
}
