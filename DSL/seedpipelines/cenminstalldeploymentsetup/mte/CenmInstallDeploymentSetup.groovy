...
def pipelineBeingGeneratedName = "MTE_cENM_Install_Deployment_Setup_Flow"
  ...
  <li>It Adds Prepopulated nodes for RFA250</li>
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_install_deployment_setup/mte/Jenkinsfile")
        }
    }
}
