...
def pipelineBeingGeneratedName = "CDL_cENM_Install_Deployment_Setup_Flow"
  ...
  <li>It copies RVB TestScripts repo to the Environment</li>
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_install_deployment_setup/cdl/Jenkinsfile")
        }
    }
}
