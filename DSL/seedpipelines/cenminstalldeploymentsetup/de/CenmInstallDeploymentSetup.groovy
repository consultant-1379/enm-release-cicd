...
def pipelineBeingGeneratedName = "DE_cENM_Install_Deployment_Setup_Flow"
  ...
  <li>It Performs Mediations Restart</li>
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_install_deployment_setup/de/Jenkinsfile")
        }
    }
}
