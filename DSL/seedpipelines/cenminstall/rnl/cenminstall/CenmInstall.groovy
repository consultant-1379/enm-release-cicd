...
def pipelineBeingGeneratedName = "RNL_cENM_Initial_Install_Functional_Flow"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '<p>This Job is used to orchestrate the install of ENM on a cENM environment for Real Node Loop.</p>'))
...
If you choose deployment mechanism as CSAR please select the value as eric-enm-integration-production-values or eric-enm-integration-extra-large-production-values only.
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_install/rnl/cenminstall/Jenkinsfile")
        }
    }
}
