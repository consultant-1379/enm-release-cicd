...
def pipelineBeingGeneratedName = "MTE_cENM_NonFunctional_Network_and_Workload_Setup_Flow"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '<p>This Job is used to set up the network and workload on a cloud native environment for MTE.</p>'))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_install_network_and_workload_setup/mte/Jenkinsfile")
        }
    }
}
