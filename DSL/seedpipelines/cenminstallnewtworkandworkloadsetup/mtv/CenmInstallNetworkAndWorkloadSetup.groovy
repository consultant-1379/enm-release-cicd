...
def pipelineBeingGeneratedName = "MTV_cENM_NonFunctional_Network_and_Workload_Setup_Flow"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/parent_pipelines/cenm_install_network_and_workload_setup/mtv/Jenkinsfile")
        }
    }
}
