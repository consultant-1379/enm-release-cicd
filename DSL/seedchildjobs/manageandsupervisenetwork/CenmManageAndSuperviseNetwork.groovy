...
def pipelineBeingGeneratedName = "cENM_Manage_And_Supervise_Network"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        '''<p>This job is used to manage/supervise the network.</p>
<p>GSM nodes are temporarily excluded here. This will be reverted back in 22.4 as part of RTD-19268</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/child_jobs/manage_and_supervise_network/Jenkinsfile")
        }
    }
}
