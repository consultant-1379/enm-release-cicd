...
def pipelineBeingGeneratedName = "cENM_Docker_Registry_Cleanup"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '<p>This job is used to cleanup the Docker Registry of a cENM Cluster. </p>'))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/child_jobs/cenm_docker_registry_cleanup/Jenkinsfile")
        }
    }
}