...
def pipelineBeingGeneratedName = "cENM_CAPO_Upgrade_Flow"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        '''<p>This job will trigger the CAPO UPGRADE Spinnaker Pipeline </p>
<p>This job will wait until the Spinnaker pipeline is completed</p>
<ul>
  <p> Link of Spinnaker pipeline to be triggered :</p>
  <p> </p>
<b> Job developed and maintained by Bumblebee : </b> <a href="mailto:BumbleBee.ENM@tcs.com?Subject=cENM_CAPO_Upgrade_Flow%20Job" target="_top">Send Mail</a> to provide feedback
</ul>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/child_jobs/cenm_capo_upgrade_flow/Jenkinsfile")
        }
    }
}
