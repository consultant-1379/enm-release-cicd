...
def pipelineBeingGeneratedName = "cENM_Apply_Priority_2_Workload"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        '<p>This job is used to apply the specified priority (2) workload profiles to the SUT.</p>'))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/child_jobs/apply_priority_2_workload/Jenkinsfile")
        }
    }
}
