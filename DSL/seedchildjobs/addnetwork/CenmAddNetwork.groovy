...
def pipelineBeingGeneratedName = "cENM_Add_Network"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        '<p>This job is used to add the network to ENM.</p>'))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("Jenkinsfiles/child_jobs/add_network/Jenkinsfile")
        }
    }
}
