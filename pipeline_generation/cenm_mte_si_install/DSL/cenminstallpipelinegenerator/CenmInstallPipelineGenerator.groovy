...
def pipelineBeingGeneratedName = "MTE_SI_cENM_Install_Pipeline_Generator"

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to generate an initial MTE SI cENM II pipeline</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm_mte_si_install/pipeline_generator/Jenkinsfile")
        }
    }
}
