...
def pipelineBeingGeneratedName = "DE_cENM_Spinnaker_5K_Rollback_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated DE cENM 5K Rollback pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/5k_rollback/de/pipeline_updater/Jenkinsfile")
        }
    }
}