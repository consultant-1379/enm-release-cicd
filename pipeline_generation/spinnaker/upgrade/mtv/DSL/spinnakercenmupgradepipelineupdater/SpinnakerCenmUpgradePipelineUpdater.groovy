...
def pipelineBeingGeneratedName = "MTV_cENM_Spinnaker_Upgrade_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated spinnaker MTV cENM UG pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/upgrade/mtv/pipeline_updater/Jenkinsfile")
        }
    }
}
