...
def pipelineBeingGeneratedName = "MTE_cENM_Spinnaker_Upgrade_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/upgrade/mte/pipeline_updater/Jenkinsfile")
        }
    }
}
