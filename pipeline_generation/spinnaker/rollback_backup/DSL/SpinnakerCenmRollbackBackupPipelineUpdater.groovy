...
def pipelineBeingGeneratedName = "cENM_Spinnaker_Rollback_Backup_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated cENM Rollback Backup pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/rollback_backup/pipeline_updater/Jenkinsfile")
        }
    }
}