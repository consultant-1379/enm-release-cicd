...
def pipelineBeingGeneratedName = "DE_cENM_Spinnaker_5K_TESTHOTEL_Restore_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated De cENM 5K Testhotel Restore pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/5k_testhotel_restore/de/pipeline_updater/Jenkinsfile")
        }
    }
}
