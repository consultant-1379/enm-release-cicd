...
def pipelineBeingGeneratedName = "DE_cENM_5K_TESTHOTEL_Restore_Backup_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated DE cENM 5K TESTHOTEL Restore Backup pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/restore_backup/de/pipeline_updater/Jenkinsfile")
        }
    }
}