...
def pipelineBeingGeneratedName = "cENM_Spinnaker_Restore_Backup_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated cENM Restore Backup pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/restore_backup/pipeline_updater/Jenkinsfile")
        }
    }
}