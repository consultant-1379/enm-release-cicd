...
def pipelineBeingGeneratedName = "CDL_cENM_Spinnaker_Install_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated spinnaker CDL cENM II pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/install/cdl/pipeline_updater/Jenkinsfile")
        }
    }
}
