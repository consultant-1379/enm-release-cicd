...
def pipelineBeingGeneratedName = "RNL_cENM_Spinnaker_Install_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/install/rnl/pipeline_updater/Jenkinsfile")
        }
    }
}
