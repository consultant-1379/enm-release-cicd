...
def pipelineBeingGeneratedName = "MTE_cENM_Spinnaker_Install_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/install/mte/pipeline_updater/Jenkinsfile")
        }
    }
}
