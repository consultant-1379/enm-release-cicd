...
def pipelineBeingGeneratedName = "MTE_SI_cENM_Spinnaker_Install_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to install an already generated spinnaker cENM II pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/install/mte_si/pipeline_updater/Jenkinsfile")
        }
    }
}
