...
def pipelineBeingGeneratedName = "cENM_Spinnaker_cENM_CBRS_Intg_Rollback_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated spinnaker cENM CBRS Integrated Rollback pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/integrated_cbrs_rollback/pipeline_updater/Jenkinsfile")
        }
    }
}