...
def pipelineBeingGeneratedName = "cENM_Spinnaker_CBRS_DCSA_Rollback_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated spinnaker cENM CBRS DCSA Rollback pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/spinnaker/cbrs_dcsa_rollback/pipeline_updater/Jenkinsfile")
        }
    }
}