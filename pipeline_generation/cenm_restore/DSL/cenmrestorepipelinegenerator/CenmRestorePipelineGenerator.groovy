...
def pipelineBeingGeneratedName = "cENM_Restore_Generator"

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to generate an initial cENM Restore pipeline.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm_restore/pipeline_generator/Jenkinsfile")
        }
    }
}