...
def pipelineBeingGeneratedName = "cENM_Rollback_Generator"

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to generate a cENM Rollback pipeline.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm_rollback/pipeline_generator/Jenkinsfile")
        }
    }
}