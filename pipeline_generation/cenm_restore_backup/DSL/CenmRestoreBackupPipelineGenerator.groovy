...
def pipelineBeingGeneratedName = "cENM_Restore_Backup_Generator"

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to generate an initial cENM Restore Backup pipeline.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm_restore_backup/pipeline_generator/Jenkinsfile")
        }
    }
}