...
def pipelineBeingGeneratedName = "DE_cENM_Initial_Install_Pipeline_Generator"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm_install_deployment_setup_and_nw_setup/pipeline_generator/de/Jenkinsfile")
        }
    }
}
