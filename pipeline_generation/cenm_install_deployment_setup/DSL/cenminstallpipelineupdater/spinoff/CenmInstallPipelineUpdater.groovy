...
def pipelineBeingGeneratedName = "SPINOFF_cENM_Initial_Install_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm_install_deployment_setup/pipeline_updater/spinoff/Jenkinsfile")
        }
    }
}
