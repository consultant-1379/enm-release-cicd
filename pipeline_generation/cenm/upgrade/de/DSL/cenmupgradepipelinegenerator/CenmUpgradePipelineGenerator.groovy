...
def pipelineBeingGeneratedName = "DE_cENM_Upgrade_Pipeline_Generator"

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to generate an initial DE cENM UG pipeline.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm/upgrade/de/pipeline_generator/Jenkinsfile")
        }
    }
}
