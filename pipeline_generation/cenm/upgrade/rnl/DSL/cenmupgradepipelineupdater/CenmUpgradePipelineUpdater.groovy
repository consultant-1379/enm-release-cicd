...
def pipelineBeingGeneratedName = "RNL_cENM_Upgrade_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated RNL cENM UG pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm/upgrade/rnl/pipeline_updater/Jenkinsfile")
        }
    }
}
