...
def pipelineBeingGeneratedName = "RNL_cENM_Upgrade_Pipeline_Generator"

pipelineJob(pipelineBeingGeneratedName) {

    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to generate an initial RNL cENM UG pipeline generator.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm/upgrade/rnl/pipeline_generator/Jenkinsfile")
        }
    }
}
