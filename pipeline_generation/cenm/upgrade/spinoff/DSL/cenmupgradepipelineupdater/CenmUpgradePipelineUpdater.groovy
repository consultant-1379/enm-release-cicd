...
def pipelineBeingGeneratedName = "SPINOFF_cENM_Upgrade_Pipeline_Updater"
...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName, '''<p>This Job is used to update an already generated cENM UG pipeline based on the changes to the master branch on gerrit.</p>'''))
    ...
    definition {
        cpsScm {
            ...
            scriptPath("pipeline_generation/cenm/upgrade/spinoff/pipeline_updater/Jenkinsfile")
        }
    }
}
